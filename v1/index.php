...
$translations = [
    ...
    'english' => [
        ...
        'pill_3_title' => 'Secure',
        'pill_3_desc' => 'encrypted & feature-rich',
        ...
        'f_company_desc' => 'Create or switch companies by name or ID (e.g. “Create a company named HorizonTech”, “Switch to company AlphaCorp”). The system sets up basic structure as you provide initial data.',
        ...
        'f_reminders_desc' => 'Set reminders for companies, positions or individuals: one-off, recurring or scheduled. Example: “Create a reminder called ‘Monthly Report’ to start in 60 seconds, repeat every 3600 seconds”.',

        'about_title' => 'About BigManage',
        'about_p1' => 'BigManage is immediately accessible via Instagram, Meta Messenger, WhatsApp, Discord, Telegram and email — so you can start using the service from tools you already use, without learning a new interface. Because BigManage operates through chat prompts rather than menu-driven screens, most people understand how to use it in under an hour. You learn by doing: send a message, see the result, and adjust — that hands-on loop makes training fast and intuitive.',
        'about_p2' => 'Think of BigManage as a helpful colleague: your messages are parsed, routed and handled by the right parts of the system. Short conversational inputs can trigger complex actions because the platform breaks down what you write and executes each step — just like talking to a person who understands your intent. Whether you’re an individual or a company, we make support personal. We publish our emails and phone numbers, respond promptly, and will arrange calls or meetings when needed. Reach out anytime — if we\'re unavailable we\'ll return your message quickly to understand the issue and help find the best solution.',
        ...
        'how_create_desc' => 'Example: “Create a company named HorizonTech.” BigManage sets up the initial company structure automatically.',
        'how_add' => 'Add employees & assign positions',
        'how_add_desc' => 'Example: “Add a new employee with email john.doe@example.com” — BigManage will find or create the employee and handle invites or assignments.',
        'how_positions' => 'Create and manage positions',
        'how_positions_desc' => 'Create, rename or delete positions and set who reports to whom using natural language. Example: “Create a Marketing Manager position.”',
        'how_access' => 'Access & time access',
        'how_access_desc' => 'Use commands to grant temporary access or set company/position time windows, e.g. “Set the company’s time access from 08:00 to 18:00.”',
        'how_reminders' => 'Reminders',
        'how_reminders_desc' => 'Set reminders by conversation. Example: “Create a reminder called ‘Monthly Report’ to start in 60 seconds, repeat every 3600 seconds.”',
    ...
    'greek' => [
        ...
        'pill_3_desc' => 'κρυπτογραφημένο και πλούσιο σε λειτουργίες',
        ...
        'f_company_desc' => 'Δημιουργήστε ή αλλάξτε εταιρείες με όνομα ή ID (π.χ. «Δημιούργησε την εταιρεία HorizonTech», «Άλλαξε στην εταιρεία AlphaCorp»). Το σύστημα ρυθμίζει τη βασική δομή καθώς παρέχετε τα αρχικά δεδομένα.',
        ...
        'f_reminders_desc' => 'Ορίστε υπενθυμίσεις για εταιρείες, θέσεις ή μεμονωμένα άτομα: μονοετείς, επαναλαμβανόμενες ή προγραμματισμένες. Παράδειγμα: «Δημιούργησε υπενθύμιση ‘Μηνιαία Αναφορά’ να ξεκινήσει σε 60 δευτερόλεπτα, επανάληψη κάθε 3600 δευτερόλεπτα».',

        'about_title' => 'Σχετικά με το BigManage',
        'about_p1' => 'Το BigManage είναι άμεσα προσβάσιμο μέσω Instagram, Meta Messenger, WhatsApp, Discord, Telegram και email — οπότε μπορείτε να ξεκινήσετε άμεσα από εργαλεία που ήδη χρησιμοποιείτε, χωρίς να μάθετε νέο περιβάλλον. Επειδή το BigManage λειτουργεί με εντολές συνομιλίας αντί για μενού, οι περισσότεροι χρήστες το κατανοούν σε λιγότερο από μία ώρα. Μαθαίνετε πρακτικά: στείλτε μήνυμα, δείτε το αποτέλεσμα και προσαρμόστε — αυτό το βρόγχο μάθησης κάνει την εκμάθηση γρήγορη και διαισθητική.',
        'about_p2' => 'Σκεφτείτε το BigManage σαν έναν συνεργάτη που βοηθάει: τα μηνύματά σας αναλύονται, δρομολογούνται και επεξεργάζονται από τα κατάλληλα μέρη του συστήματος. Σύντομες συνομιλητικές εντολές μπορούν να ενεργοποιήσουν σύνθετες ενέργειες επειδή η πλατφόρμα διασπά όσα γράφετε και εκτελεί κάθε βήμα — σαν να μιλάτε με κάποιον που καταλαβαίνει την πρόθεσή σας. Είτε είστε ιδιώτης είτε εταιρεία, παρέχουμε προσωπική υποστήριξη. Δημοσιεύουμε τα email και τα τηλέφωνά μας, απαντάμε γρήγορα και οργανώνουμε κλήσεις ή συναντήσεις όταν χρειάζεται. Επικοινωνήστε όποτε θέλετε και θα επιστρέψουμε το μήνυμά σας άμεσα για να κατανοήσουμε το ζήτημα και να βοηθήσουμε.',
        ...
        'how_create_desc' => 'Παράδειγμα: «Δημιούργησε την εταιρεία HorizonTech.» Το BigManage ρυθμίζει αυτόματα την αρχική δομή της εταιρείας.',
        'how_add' => 'Προσθήκη υπαλλήλων & ανάθεση θέσεων',
        'how_add_desc' => 'Παράδειγμα: «Πρόσθεσε νέο υπάλληλο με email john.doe@example.com» — το BigManage θα βρει ή θα δημιουργήσει τον υπάλληλο και θα διεκπεραιώσει προσκλήσεις ή αναθέσεις.',
        'how_positions' => 'Δημιουργία και διαχείριση θέσεων',
        'how_positions_desc' => 'Δημιουργήστε, μετονομάστε ή διαγράψτε θέσεις και ορίστε ποιος αναφέρεται σε ποιον χρησιμοποιώντας φυσική γλώσσα. Παράδειγμα: «Δημιούργησε θέση Marketing Manager.»',
        'how_access' => 'Πρόσβαση & χρονικοί περιορισμοί',
        'how_access_desc' => 'Χρησιμοποιήστε εντολές για να δώσετε προσωρινή πρόσβαση ή να ορίσετε χρονικά παράθυρα πρόσβασης για εταιρείες/θέσεις, π.χ. «Ορισμός πρόσβασης εταιρείας από 08:00 έως 18:00».',
...
$lang = $_GET['language'] ?? 'english';
if (!in_array($lang, ['english', 'greek'])) {
    $lang = 'english';
}
$t = $translations[$lang];
