...
$translations = [
    ...
    'english' => [
        ...
        'f_employees' => 'Members & onboarding',
        'f_employees_desc' => 'Add or invite members using an email address; accept join requests. BigManage finds or creates member records from the provided email.',
        ...
        'f_access_desc' => 'Manage general access and create time-bound permissions for companies, positions or members. Use natural language to set start/end times and expirations.',
    ...
    'greek' => [
        ...
        'f_employees' => 'members & εισαγωγή',
        'f_employees_desc' => 'Προσθέστε ή προσκαλέστε members με διεύθυνση email· αποδεχθείτε αιτήματα ένταξης. Το BigManage βρίσκει ή δημιουργεί εγγραφές members από το παρεχόμενο email.',
        ...
        'f_access_desc' => 'Διαχειριστείτε γενικές προσβάσεις και δημιουργήστε χρονικά περιορισμένες άδειες για εταιρείες, θέσεις ή members. Χρησιμοποιήστε φυσική γλώσσα για να ορίσετε ώρες έναρξης/λήξης και λήξεις.',
    ...
    'dutch' => [
        ...
        'f_employees' => 'members & onboarding',
        'f_employees_desc' => 'Voeg members toe of nodig ze uit met een e-mailadres; accepteer toetredingsverzoeken. BigManage vindt of maakt membersprofielen op basis van het opgegeven e-mailadres.',
        ...
        'f_access_desc' => 'Beheer algemene toegang en creëer tijdgebonden permissies voor bedrijven, posities of members. Gebruik natuurlijke taal om start-/eindtijden en verlopen in te stellen.',
    ...
    'german' => [
        ...
        'f_employees' => 'members & Onboarding',
        'f_employees_desc' => 'Mitarbeiter hinzufügen oder einladen per E-Mail-Adresse; Beitrittsanfragen annehmen. BigManage findet oder erstellt membersdatensätze anhand der angegebenen E-Mail.',
        ...
        'f_access_desc' => 'Allgemeine Zugänge verwalten und zeitlich begrenzte Berechtigungen für Firmen, Positionen oder members erstellen. Verwenden Sie natürliche Sprache, um Start-/Endzeiten und Ablaufzeiten zu setzen.',
    ...
    'italian' => [
        ...
        'f_employees' => 'members & onboarding',
        'f_employees_desc' => 'Aggiungi o invita members tramite indirizzo email; accetta richieste di adesione. BigManage trova o crea i record dei members in base all\'email fornita.',
        ...
        'f_access_desc' => 'Gestisci accessi generali e crea permessi temporizzati per aziende, posizioni o members. Usa linguaggio naturale per impostare orari di inizio/fine ed eventuali scadenze.',
    ...
    'french' => [
        ...
        'f_employees' => 'members & onboarding',
        'f_employees_desc' => 'Ajouter ou inviter members via une adresse email ; accepter des demandes d\'adhésion. BigManage trouve ou crée les enregistrements members à partir de l\'email fourni.',
        ...
        'f_access_desc' => 'Gérer les accès généraux et créer des permissions temporisées pour sociétés, postes ou members. Utiliser un langage naturel pour définir heures de début/fin et expirations.',
    ...
    'portuguese' => [
        ...
        'f_employees' => 'members & integração',
        'f_employees_desc' => 'Adicione ou convide members usando um endereço de email; aceite pedidos de entrada. O BigManage encontra ou cria registros de members a partir do email fornecido.',
        ...
        'f_access_desc' => 'Gerencie acessos gerais e crie permissões temporizadas para empresas, cargos ou members. Use linguagem natural para definir horários de início/fim e expirações.',
    ...
    'spanish' => [
        ...
        'f_employees' => 'members & incorporación',
        'f_employees_desc' => 'Añada o invite members usando una dirección de correo; acepte solicitudes de incorporación. BigManage encuentra o crea registros de members a partir del correo proporcionado.',
        ...
        'f_access_desc' => 'Gestione accesos generales y cree permisos por tiempo para empresas, puestos o members. Use lenguaje natural para establecer horas de inicio/fin y expiraciones.',
