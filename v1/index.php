...
$translations = [
    ...
    'english' => [
        ...
        'features_desc' => 'Everything you need to manage companies, employees, positions, access and scheduling through natural chat prompts — directly from platforms you already use.',
        'f_company' => 'Company management',
        'f_company_desc' => 'Create or switch companies by name or ID. The system sets up structure as you provide data.',
        'f_employees' => 'Employees & onboarding',
        'f_employees_desc' => 'Add or invite employees using an email address; accept join requests. BigManage finds or creates employee records from the provided email.',
        'f_positions' => 'Positions & hierarchy',
        'f_positions_desc' => 'Create, rename, delete or assign positions; manage reporting levels and set relative hierarchy (above / below / equal).',
        'f_departments' => 'Departments & organization',
        'f_departments_desc' => 'Group positions into departments, rename or delete departments, and attach or detach positions to reflect company reorganizations.',
        'f_access' => 'Access & time-based controls',
        'f_access_desc' => 'Manage general access and create time-bound permissions for companies, positions or employees. Use natural language to set start/end times and expirations.',
        'f_reminders' => 'Reminders & scheduling',
        'f_reminders_desc' => 'Set reminders for companies, positions or individuals: one-off, recurring or scheduled.',
        ...
        'how_add' => 'Add employees & assign positions',
        'how_add_desc' => 'Example: “Add a new employee with email john.doe@example.com.”',
    ...
    'greek' => [
        ...
        'features_desc' => 'Όλα όσα χρειάζεστε για να διαχειρίζεστε εταιρείες, υπαλλήλους, θέσεις, πρόσβαση και προγραμματισμό μέσω φυσικών εντολών συνομιλίας — απευθείας από τα εργαλεία που ήδη χρησιμοποιείτε.',
        'f_company' => 'Διαχείριση εταιρειών',
        'f_company_desc' => 'Δημιουργήστε ή αλλάξτε εταιρείες με όνομα ή ID. Το σύστημα ρυθμίζει τη δομή καθώς παρέχετε τα δεδομένα.',
        'f_employees' => 'Υπάλληλοι & εισαγωγή',
        'f_employees_desc' => 'Προσθέστε ή προσκαλέστε υπαλλήλους με διεύθυνση email· αποδεχθείτε αιτήματα ένταξης. Το BigManage βρίσκει ή δημιουργεί εγγραφές υπαλλήλων από το παρεχόμενο email.',
        'f_positions' => 'Θέσεις & ιεραρχία',
        'f_positions_desc' => 'Δημιουργήστε, μετονομάστε, διαγράψτε ή αναθέστε θέσεις· διαχειριστείτε επίπεδα αναφοράς και ορίστε σχετική ιεραρχία (πάνω / κάτω / ίσο).',
        'f_departments' => 'Τμήματα & οργάνωση',
        'f_departments_desc' => 'Ομαδοποιήστε θέσεις σε τμήματα, μετονομάστε ή διαγράψτε τμήματα και επισυνάψτε ή αποσυνδέστε θέσεις για την αναδιάρθρωση της εταιρείας.',
        'f_access' => 'Έλεγχος πρόσβασης & χρονικά όρια',
        'f_access_desc' => 'Διαχειριστείτε γενικές προσβάσεις και δημιουργήστε χρονικά περιορισμένες άδειες για εταιρείες, θέσεις ή υπαλλήλους. Χρησιμοποιήστε φυσική γλώσσα για να ορίσετε ώρες έναρξης/λήξης και λήξεις.',
        'f_reminders' => 'Υπενθυμίσεις & προγραμματισμός',
        'f_reminders_desc' => 'Ορίστε υπενθυμίσεις για εταιρείες, θέσεις ή μεμονωμένα άτομα: μονοετείς, επαναλαμβανόμενες ή προγραμματισμένες.',
        ...
        'how_add' => 'Προσθήκη υπαλλήλων & ανάθεση θέσεων',
        'how_add_desc' => 'Παράδειγμα: «Πρόσθεσε νέο υπάλληλο με email john.doe@example.com»',
    ...
    'dutch' => [
        ...
        'features_desc' => 'Alles wat u nodig hebt om bedrijven, medewerkers, posities, toegang en planning te beheren via natuurlijke chatopdrachten — direct vanuit de platforms die u al gebruikt.',
        'f_company' => 'Bedrijfsbeheer',
        'f_company_desc' => 'Maak bedrijven aan of schakel tussen bedrijven op naam of ID. Het systeem zet de structuur op terwijl u gegevens levert.',
        'f_employees' => 'Werknemers & onboarding',
        'f_employees_desc' => 'Voeg werknemers toe of nodig ze uit met een e-mailadres; accepteer toetredingsverzoeken. BigManage vindt of maakt werknemersprofielen op basis van het opgegeven e-mailadres.',
        'f_positions' => 'Posities & hiërarchie',
        'f_positions_desc' => 'Maak, hernoem, verwijder of wijs posities toe; beheer rapportagelagen en stel relatieve hiërarchie in (boven / onder / gelijk).',
        'f_departments' => 'Afdelingen & organisatie',
        'f_departments_desc' => 'Groepeer posities in afdelingen, hernoem of verwijder afdelingen en koppel of ontkoppel posities bij reorganisaties.',
        'f_access' => 'Toegang & tijdsgebonden regels',
        'f_access_desc' => 'Beheer algemene toegang en creëer tijdgebonden permissies voor bedrijven, posities of werknemers. Gebruik natuurlijke taal om start-/eindtijden en verlopen in te stellen.',
        'f_reminders' => 'Herinneringen & planning',
        'f_reminders_desc' => 'Stel herinneringen in voor bedrijven, posities of individuen: eenmalig, terugkerend of gepland.',
        ...
        'how_add' => 'Werknemers toevoegen & posities toewijzen',
        'how_add_desc' => 'Voorbeeld: “Voeg een nieuwe werknemer toe met e-mail john.doe@example.com.”',
    ...
    'german' => [
        ...
        'features_desc' => 'Alles, was Sie benötigen, um Firmen, Mitarbeiter, Positionen, Zugänge und Zeitplanung per natürlicher Chatsteuerung zu verwalten — direkt aus den Plattformen, die Sie bereits nutzen.',
        'f_company' => 'Firmenverwaltung',
        'f_company_desc' => 'Erstellen oder wechseln Sie Firmen per Name oder ID. Das System richtet die Struktur ein, während Sie Daten bereitstellen.',
        'f_employees' => 'Mitarbeiter & Onboarding',
        'f_employees_desc' => 'Mitarbeiter hinzufügen oder einladen per E-Mail-Adresse; Beitrittsanfragen annehmen. BigManage findet oder erstellt Mitarbeiterdatensätze anhand der angegebenen E-Mail.',
        'f_positions' => 'Positionen & Hierarchie',
        'f_positions_desc' => 'Positionen erstellen, umbenennen, löschen oder zuweisen; Berichtsebenen verwalten und relative Hierarchie festlegen (über / unter / gleich).',
        'f_departments' => 'Abteilungen & Organisation',
        'f_departments_desc' => 'Positionen in Abteilungen gruppieren, Abteilungen umbenennen oder löschen und Positionen anhängen oder trennen bei Reorganisationen.',
        'f_access' => 'Zugriff & zeitbasierte Rechte',
        'f_access_desc' => 'Allgemeine Zugänge verwalten und zeitlich begrenzte Berechtigungen für Firmen, Positionen oder Mitarbeiter erstellen. Verwenden Sie natürliche Sprache, um Start-/Endzeiten und Ablaufzeiten zu setzen.',
        'f_reminders' => 'Erinnerungen & Zeitplanung',
        'f_reminders_desc' => 'Erinnerungen für Firmen, Positionen oder Einzelpersonen setzen: einmalig, wiederkehrend oder geplant.',
        ...
        'how_add' => 'Mitarbeiter hinzufügen & Positionen zuweisen',
        'how_add_desc' => 'Beispiel: „Füge einen neuen Mitarbeiter mit E-Mail john.doe@example.com hinzu.“',
    ...
    'italian' => [
        ...
        'features_desc' => 'Tutto ciò di cui hai bisogno per gestire aziende, dipendenti, posizioni, accessi e pianificazione tramite comandi in chat naturale — direttamente dalle piattaforme che già usi.',
        'f_company' => 'Gestione aziendale',
        'f_company_desc' => 'Crea o passa a società per nome o ID. Il sistema imposta la struttura man mano che fornisci i dati.',
        'f_employees' => 'Dipendenti & onboarding',
        'f_employees_desc' => 'Aggiungi o invita dipendenti tramite indirizzo email; accetta richieste di adesione. BigManage trova o crea i record dei dipendenti in base all\'email fornita.',
        'f_positions' => 'Posizioni & gerarchia',
        'f_positions_desc' => 'Crea, rinomina, elimina o assegna posizioni; gestisci i livelli di reporting e imposta la gerarchia relativa (sopra / sotto / uguale).',
        'f_departments' => 'Dipartimenti & organizzazione',
        'f_departments_desc' => 'Raggruppa posizioni in dipartimenti, rinomina o elimina dipartimenti e collega o scollega posizioni per riflettere riorganizzazioni.',
        'f_access' => 'Controlli di accesso & temporizzati',
        'f_access_desc' => 'Gestisci accessi generali e crea permessi temporizzati per aziende, posizioni o dipendenti. Usa linguaggio naturale per impostare orari di inizio/fine ed eventuali scadenze.',
        'f_reminders' => 'Promemoria & pianificazione',
        'f_reminders_desc' => 'Imposta promemoria per aziende, posizioni o individui: singoli, ricorrenti o pianificati.',
        ...
        'how_add' => 'Aggiungi dipendenti & assegna posizioni',
        'how_add_desc' => 'Esempio: “Aggiungi un nuovo dipendente con email john.doe@example.com.”',
    ...
    'french' => [
        ...
        'features_desc' => 'Tout ce dont vous avez besoin pour gérer sociétés, employés, postes, accès et planification via des commandes de chat naturel — directement depuis les plateformes que vous utilisez déjà.',
        'f_company' => 'Gestion des sociétés',
        'f_company_desc' => 'Créer ou basculer entre des sociétés par nom ou ID. Le système configure la structure au fil des données fournies.',
        'f_employees' => 'Employés & onboarding',
        'f_employees_desc' => 'Ajouter ou inviter des employés via une adresse email ; accepter des demandes d\'adhésion. BigManage trouve ou crée les enregistrements employés à partir de l\'email fourni.',
        'f_positions' => 'Postes & hiérarchie',
        'f_positions_desc' => 'Créer, renommer, supprimer ou attribuer des postes ; gérer les niveaux de reporting et définir la hiérarchie relative (au-dessus / en dessous / égal).',
        'f_departments' => 'Départements & organisation',
        'f_departments_desc' => 'Grouper des postes en départements, renommer ou supprimer des départements, et attacher/détacher des postes lors de réorganisations.',
        'f_access' => 'Accès & contrôles temporisés',
        'f_access_desc' => 'Gérer les accès généraux et créer des permissions temporisées pour sociétés, postes ou employés. Utiliser un langage naturel pour définir heures de début/fin et expirations.',
        'f_reminders' => 'Rappels & planification',
        'f_reminders_desc' => 'Définir des rappels pour sociétés, postes ou individus : ponctuels, récurrents ou planifiés.',
        ...
        'how_add' => 'Ajouter des employés & attribuer des postes',
        'how_add_desc' => 'Exemple : « Ajoutez un nouvel employé avec l\'email john.doe@example.com. »',
    ...
    'portuguese' => [
        ...
        'features_desc' => 'Tudo o que você precisa para gerenciar empresas, funcionários, cargos, acessos e agendamento por comandos de chat natural — diretamente das plataformas que você já usa.',
        'f_company' => 'Gestão de empresas',
        'f_company_desc' => 'Crie ou mude de empresa por nome ou ID. O sistema configura a estrutura conforme você fornece dados.',
        'f_employees' => 'Funcionários & integração',
        'f_employees_desc' => 'Adicione ou convide funcionários usando um endereço de email; aceite pedidos de entrada. O BigManage encontra ou cria registros de funcionários a partir do email fornecido.',
        'f_positions' => 'Cargos & hierarquia',
        'f_positions_desc' => 'Crie, renomeie, exclua ou atribua cargos; gerencie níveis de reporte e defina hierarquia relativa (acima / abaixo / igual).',
        'f_departments' => 'Departamentos & organização',
        'f_departments_desc' => 'Agrupe cargos em departamentos, renomeie ou exclua departamentos, e anexe ou destaque cargos para refletir reorganizações.',
        'f_access' => 'Acesso & controles temporizados',
        'f_access_desc' => 'Gerencie acessos gerais e crie permissões temporizadas para empresas, cargos ou funcionários. Use linguagem natural para definir horários de início/fim e expirações.',
        'f_reminders' => 'Lembretes & agendamento',
        'f_reminders_desc' => 'Defina lembretes para empresas, cargos ou indivíduos: únicos, recorrentes ou agendados.',
        ...
        'how_add' => 'Adicionar funcionários & atribuir cargos',
        'how_add_desc' => 'Exemplo: "Adicione um novo funcionário com email john.doe@example.com."',
    ...
    'spanish' => [
        ...
        'features_desc' => 'Todo lo que necesita para gestionar empresas, empleados, puestos, accesos y planificación mediante comandos de chat natural — directamente desde las plataformas que ya utiliza.',
        'f_company' => 'Gestión de empresas',
        'f_company_desc' => 'Cree o cambie empresas por nombre o ID. El sistema configura la estructura mientras proporciona datos.',
        'f_employees' => 'Empleados & incorporación',
        'f_employees_desc' => 'Añada o invite empleados usando una dirección de correo; acepte solicitudes de incorporación. BigManage encuentra o crea registros de empleados a partir del correo proporcionado.',
        'f_positions' => 'Puestos & jerarquía',
        'f_positions_desc' => 'Cree, renombre, elimine o asigne puestos; gestione niveles de reporte y establezca jerarquía relativa (arriba / abajo / igual).',
        'f_departments' => 'Departamentos & organización',
        'f_departments_desc' => 'Agrupe puestos en departamentos, renombre o elimine departamentos, y conecte o desconecte puestos para reflejar reorganizaciones.',
        'f_access' => 'Acceso & controles temporales',
        'f_access_desc' => 'Gestione accesos generales y cree permisos por tiempo para empresas, puestos o empleados. Use lenguaje natural para establecer horas de inicio/fin y expiraciones.',
        'f_reminders' => 'Recordatorios & programación',
        'f_reminders_desc' => 'Establezca recordatorios para empresas, puestos o individuos: puntuales, recurrentes o programados.',
        ...
        'how_add' => 'Añadir empleados & asignar puestos',
        'how_add_desc' => 'Ejemplo: “Añade un nuevo empleado con email john.doe@example.com.”',
